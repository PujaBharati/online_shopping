...
<div id="templatemo_top_panel">
    	<div id="templatemo_language_section">
			<h1 style="font-family:cooper std white;font-size:20px;color: white;text-align:center;"><marquee scrollamount="10" width="40">&lt;&lt;&lt;</marquee>Welcome To Online Shopping Cart<marquee scrollamount="5" direction="right" width="40">&gt;&gt;&gt;</marquee>
		</h1>
        </div>
     ...
     <div id="templatemo_banner" >
     	<a href="#"> <img src="images/cover.jpg" alt="" title="Welcome Again" border="0" style="width: 1000px;height: 180px;"/>     </a>      </div>
...
<div id="templatemo_menu_panel">
        <ul>
            <li><a href="cartpage.jsp" class="current">Home</a></li>
            <li><a href="feedback.jsp" target="_parent">Feedback</a></li>
            <li><a href="comment.jsp">View Comments</a></li> 
            <li><a href="viewprof.jsp" target="_parent">View Profile</a></li>
            <li><a href="contact.jsp" target="_parent">Contact Us</a></li>  
    ...
    <div id="templatemo_content">
        ...
        <marquee behavior="scroll" direction="left"><img src="go.gif" width="156" height="182" alt="Natural" /><img src="go.gif" width="156" height="182" alt="Natural" /></marquee>
        ...
        <h1> <font color="yellow">-:  ABOUT US   :-</font></h1>
        
          <div id="templatemo_footer">
          1.1 We will only use your Personal Information for the purpose(s) for which you provide it to us including, for example, to:
          <br>
...
<br>
(e) prevent or detect fraud or abuses of our Website; and
</br>
(f) enable third parties to carry out technical, logistical or other functions on our behalf.
<br>
1.2 We will not rent or sell your Personal Information to any third party without your permission.
